module Features
  module CampaignHelpers
    def fill_campaign_form
      ...
      select campaign.start_date.strftime("%e"), from: 'campaign_start_date_3i'
      ...
      select campaign.end_date.strftime("%e"), from: 'campaign_end_date_3i'
      ...
      find(:id, 'campaign_image').set Rails.root.to_s + '/spec/mocks/ruby.png'
      if campaign.meme
        check 'campaign_meme'
