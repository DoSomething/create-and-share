CreateAndShare::Application.configure do
  ...
  config.assets.precompile += ['html5.js', 'gate.js', 'gate.css', 'admin/admin.css', 'admin.js', 'jquery.Jcrop.min.css', 'jquery.Jcrop.min.js', 'facebook.png', 'blank.gif']
